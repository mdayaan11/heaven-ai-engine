...
def layout_tsx(project_name: str) -> str:
    """Root layout — required by every Next.js App Router project.
    Hardcoded because a broken/empty layout.tsx fails the ENTIRE build,
    not just one page."""
...
def page_tsx(project_name: str) -> str:
    """Generic but valid homepage shell. Always compiles, regardless of
    what Gemini would have generated."""
...
def globals_css() -> str:
    """Minimal, always-valid global stylesheet."""
    return """:root {
  --background: #ffffff;
  --foreground: #171717;
}
